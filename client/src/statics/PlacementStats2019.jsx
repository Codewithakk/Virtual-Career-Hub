...
import DomainWiseImg from "./../assets/images/domain-wise.jpg";
import ArrowsImg from "./../assets/images/arrows.jpg";
import GearsImg from "./../assets/images/gears.jpg";

const Placement2019 = (props) => {
  return (
    <div className="stats-outer-wrapper">
      ...
      <div className="images-row-4">
        <div className="images-row-4-inner"></div>
      </div>
    </div>
  );
};

export default Placement2019;
